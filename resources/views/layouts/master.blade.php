            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown show">
                    <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"
                        class="nav-link dropdown-toggle">Lang</a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <router-link to="/members-list" active-class="active" class="nav-link ">
                                        <i class="fas fa-archway nav-icon"></i>
                                        <p>View Add Members</p>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/member-profile" active-class="active" class="nav-link ">
                                        <i class="fas fa-archway nav-icon"></i>
                                        <p>Edit My Profile</p>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/family-tree" active-class="active" class="nav-link ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <router-link to="/developer" active-class="active" class="nav-link ">
                                        <i class="fas fa-archway nav-icon"></i>
                                        <p>Developer Passport</p>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/password" active-class="active" class="nav-link ">
                                        <i class="fa fa-cog nav-icon"></i>
                                        <p>Change Password</p>
                                    </router-link>
                                </li>
                                ...
                                <li class="nav-item">
                                    <router-link to="/bio" active-class="active" class="nav-link ">
                                        <i class="fa fa-cog nav-icon"></i>
                                        <p>Change Bio</p>
                                    </router-link>
                                </li>
                        ...
                        <li class="nav-item">
                            <router-link to="{{ route('logout') }}" onclick="event.preventDefault();
